    ...
    if (isError) {
        return (
            <View style={styles.errorContainer}>
                <Ionicons name="cloud-offline" size={64} color={THEME.TEXT_DARK_SECONDARY} />
    ...
    return (
        ...
        >
            ...
            >
                ...
                {/* COMING SOON BANNER (ONLY IF NOT SERVICEABLE) */}
                {user?.is_serviceable === false && (
                    <Animated.View entering={FadeInDown.delay(200).springify()}>
                        <ComingSoonBanner onPressChangeLocation={() => router.push("/addresses")} />
                    </Animated.View>
                )}
                ...
                {/* BOOK NOW CTA (ONLY IF SERVICEABLE) */}
                {user?.is_serviceable !== false && (
            ...
            <View style={styles.scrollContent}>
                ...
                <Animated.View entering={FadeInDown.delay(500).springify()}>
                    <OfferBanner
                        ...
                        couponCode="WELCOME"
                        buttonText={user?.is_serviceable !== false ? "Book Now" : undefined}
                    // onPress={user?.is_serviceable !== false ? () => router.push("/book-now") : undefined}
                    />
                </Animated.View>
...
const EmptyState = ({
    ...
    <View style={styles.emptyState}>
        <View style={styles.emptyIconContainer}>
            <Ionicons name={icon} size={40} color={THEME.TEXT_DARK_SECONDARY} />
        </View>
